...
export default function Home() {
  return <main id="top">
    <header className="wrap nav"><a className="logo" href="#top">JobApply<span /></a><nav className="navlinks"><a href="#experience">How it works</a><a href="#resources">Career guides</a><a href="#book-call">Book a call</a><a href="#offer">Pricing</a><a href="#faq">FAQ</a></nav><a className="btn btn-dark" href="#book-call">Book a consultation →</a></header>
    <InteractiveHome />
    <CareerResources />
    <CalendlyBooking />
