...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'JobApply | We Find. We Apply. You Interview.',
    description: 'A managed job application service covering candidate analysis, targeted job discovery, tailored applications, tracking and interview preparation.',
    type: 'website',
    siteName: 'JobApply',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'JobApply | Done-for-You Job Applications',
    description: 'Get professional job search support from candidate analysis through interview preparation.',
  },
